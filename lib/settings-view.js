...
class SettingsView {
  constructor() {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', 'px2rem-plus:settings', () => this.toggle()));
  ...
  confirm() {
    ...
    if (!editor || !editor.getPath() || isNaN(base)) {
  ...
  open() {
    ...
    this.panel.show();
    this.miniEditor.setText(String(helper.base));
